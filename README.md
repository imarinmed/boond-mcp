...
- [docs/AI_GUIDE.md](docs/AI_GUIDE.md) - Complete AI assistant onboarding guide (MCP config, skills, verification)
...
**If you are an AI assistant given this repo URL**, read [`docs/AI_GUIDE.md`](docs/AI_GUIDE.md) — it has everything you need to get fully operational:

- Configure the MCP server (remote HTTP or local stdio)
- Install the skill from `docs/skills/boond-mcp.md`
- Verify installation with 3 test prompts
- Security checklist
...
See [`docs/AI_SKILLS.md`](docs/AI_SKILLS.md) for what the skill teaches.
