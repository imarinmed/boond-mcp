...
import { searchParamsSchema, bankingAccountIdSchema } from '../../types/schemas.js';
import { z } from 'zod';
...
export function registerBankingTools(server: McpServer, client: BoondAPIClient): void {
  /**
